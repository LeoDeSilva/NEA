...
\begin{longtable}{ | p{2cm} | p{4cm} | p{5cm} | p{4cm} | } 
  ...
  \hline
        1.2 
        & 
        A Harvard computer architecture where data and instructions are stored in seperate memories. 
        & 
  ...
  \hline
    ...
    \hline
        2.4 & 
        My langauge should offer structures to group related variables in memory.  &
