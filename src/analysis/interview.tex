...
\begin{enumerate}
    ...
    \item \textbf{Compiler \& High Level Language}
        ...
        \begin{enumerate}
            ...
            \item My programming language should use the C like syntax elements of curly braces and semi colons as they offer more flexibility when formatting code. Since whitespace does not dictate control flow.
